        ...
        <section id="map" className="section-shell scroll-mt-20" data-testid="interactive-map-section">
          ...
          <div className="grid gap-5 xl:grid-cols-[1.65fr_1fr]">
            <div className="map-shell relative min-h-[520px] overflow-hidden rounded-2xl border border-white/[.08] bg-[#0c1421]" data-testid="india-map-canvas">
              ...
              <div className="absolute left-5 top-5 z-10"><span className="rounded-md border border-white/10 bg-[#111827]/80 px-2.5 py-1.5 font-mono text-[9px] uppercase tracking-widest text-slate-500">INDIA / HEAT STRUCTURE</span></div>
              <div className="absolute right-5 top-5 z-10 rounded-md border border-white/10 bg-[#111827]/80 px-2.5 py-1.5 font-mono text-[9px] uppercase tracking-widest text-slate-500">SCHEMATIC STATE ZONES · DEMO</div>
              <div className="absolute bottom-5 left-5 z-10 flex flex-wrap gap-3 rounded-lg border border-white/[.08] bg-[#111827]/80 px-3 py-2 backdrop-blur"><span className="text-[10px] text-slate-500">Heat structure</span>{(Object.keys(tierMeta) as RiskTier[]).map((tier) => <span key={tier} className="flex items-center gap-1.5 text-[10px] text-slate-400"><i className="h-2 w-2 rounded-full" style={{ background: tierMeta[tier].color }} />{tierMeta[tier].label.replace(" Risk", "")}</span>)}</div>
              <svg className="absolute left-[8%] top-[7%] h-[86%] w-[84%] opacity-95" viewBox="0 0 100 100" aria-label="Schematic map of India with state-region labels">
                <defs><linearGradient id="indiaMapFill" x1="0" y1="0" x2="1" y2="1"><stop stopColor="#20374a" /><stop offset="1" stopColor="#122131" /></linearGradient><clipPath id="indiaShapeClip"><path d="M34 3 L46 6 L54 13 L66 16 L73 23 L84 29 L82 38 L88 47 L80 53 L82 62 L73 68 L70 77 L63 80 L59 91 L52 98 L47 86 L39 79 L33 72 L28 63 L20 57 L18 47 L23 39 L24 29 L29 21 Z" /></clipPath></defs>
                <path d="M34 3 L46 6 L54 13 L66 16 L73 23 L84 29 L82 38 L88 47 L80 53 L82 62 L73 68 L70 77 L63 80 L59 91 L52 98 L47 86 L39 79 L33 72 L28 63 L20 57 L18 47 L23 39 L24 29 L29 21 Z" fill="url(#indiaMapFill)" stroke="#7892a2" strokeWidth=".6" />
                <g clipPath="url(#indiaShapeClip)" opacity=".65"><path d="M13 10 H90 V32 H13 Z" fill="#EF4444" opacity=".28" /><path d="M13 32 H90 V57 H13 Z" fill="#F97316" opacity=".24" /><path d="M13 57 H90 V77 H13 Z" fill="#F59E0B" opacity=".14" /><path d="M13 77 H90 V102 H13 Z" fill="#10B981" opacity=".16" /></g>
                <g fill="none" stroke="#8aa0ad" strokeOpacity=".48" strokeWidth=".32" strokeDasharray="1.2 1.1"><path d="M27 21 L39 27 L53 24 L66 30 L79 29" /><path d="M23 39 L36 38 L47 43 L60 39 L78 42 L84 47" /><path d="M20 50 L32 52 L42 48 L53 54 L69 50 L81 55" /><path d="M28 63 L40 58 L51 64 L64 59 L73 68" /><path d="M34 72 L45 68 L55 74 L69 77" /><path d="M39 27 L36 38 L42 48 L40 58 L45 68" /><path d="M53 24 L47 43 L53 54 L51 64 L55 74" /><path d="M66 30 L60 39 L69 50 L64 59 L64 73" /></g>
                <g fill="#c5d3da" fontFamily="IBM Plex Sans, sans-serif" fontSize="2.7" fontWeight="600" letterSpacing=".2"><text x="28" y="14">J&amp;K / HIMACHAL</text><text x="60" y="25">PUNJAB</text><text x="24" y="31">RAJASTHAN</text><text x="48" y="35">UTTAR PRADESH</text><text x="67" y="37">BIHAR</text><text x="30" y="47">GUJARAT</text><text x="47" y="48">MADHYA PRADESH</text><text x="68" y="48">WEST BENGAL</text><text x="29" y="58">MAHARASHTRA</text><text x="53" y="58">ODISHA</text><text x="38" y="70">KARNATAKA</text><text x="57" y="69">TELANGANA</text><text x="65" y="77">ANDHRA</text><text x="43" y="82">TAMIL NADU</text><text x="37" y="91">KERALA</text><text x="76" y="25">ASSAM</text></g>
                <path d="M61 88 C64 89 65 92 63 94 C61 95 59 93 60 91 Z" fill="#10B981" opacity=".5" stroke="#9ee7c9" strokeWidth=".3" /><text x="59.5" y="98" fill="#94A3B8" fontSize="2.4">SRI LANKA</text>
              </svg>
              {filteredCities.map((city) => { const position = mapPosition(city); const meta = tierMeta[city.tier]; return <button key={city.id} className="city-node group absolute z-10 -translate-x-1/2 -translate-y-1/2" style={{ left: position.left, top: position.top }} onClick={() => selectCity(city.id)} data-testid={`city-marker-${city.id}`} aria-label={`Select ${city.name}`}><span className={`relative grid h-5 w-5 place-items-center rounded-full border-2 border-[#0c1421] shadow-lg transition-transform group-hover:scale-150 ${selectedId === city.id ? "scale-150" : ""}`} style={{ backgroundColor: meta.color, boxShadow: `0 0 0 4px ${meta.color}20, 0 0 20px ${meta.color}80` }}><span className="h-1.5 w-1.5 rounded-full bg-white" /></span><span className={`pointer-events-none absolute left-1/2 top-7 -translate-x-1/2 whitespace-nowrap rounded bg-[#0A0E17]/90 px-1.5 py-1 text-[9px] font-medium text-slate-300 opacity-0 transition-opacity group-hover:opacity-100 ${selectedId === city.id ? "opacity-100" : ""}`}>{city.name}</span></button> })}
            </div>
