...
CITY_DATA: list[CityRisk] = [
    CityRisk(id="delhi", name="Delhi (NCR)", state="Delhi", lat=28.6139, lng=77.2090, max_temp=46.8, heatwave_days=24, pop_exposure=94, urbanization=92, vegetation_cover=18, score=88, tier="very_high", is_demo=False, source_note="Verified: IMD Safdarjung observatory, 28 May 2024 (season peak during the North-India heatwave); heatwave-day count from IMD seasonal bulletins."),
    CityRisk(id="ahmedabad", name="Ahmedabad", state="Gujarat", lat=23.0225, lng=72.5714, max_temp=46.6, heatwave_days=22, pop_exposure=85, urbanization=88, vegetation_cover=14, score=86, tier="very_high", is_demo=False, source_note="Verified: IMD bulletin, 23 May 2024 (red-alert heatwave day); heatwave-day count from IMD seasonal bulletins."),
    CityRisk(id="nagpur", name="Nagpur", state="Maharashtra", lat=21.1458, lng=79.0882, max_temp=46.7, heatwave_days=21, pop_exposure=78, urbanization=76, vegetation_cover=22, score=82, tier="very_high", is_demo=False, source_note="Verified: IMD Vidarbha sub-division bulletin, 24 May 2020 (regional heatwave peak); heatwave-day count from IMD seasonal bulletins."),
